...
<body>
	...
	<c:choose>
		<c:when test="${mode=='MODE_HOME' }">
			<div class="container" id="homediv">
				<div class="jumbotron text-center">
					<h1>SSS Shopping Mall</h1>
					<h3>No 2 Shopping Mall in Online </h3>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; SSS Shopping Mall</p></div>
        </footer>
        <!-- Bootstrap core JS-->
